...
void _acaoDoCoracao() {
  ...
  Verso(
    ...
    fim: Duration(milliseconds: 29320),
  ),
  Verso(
    original: "Farewell",
    traducao: "Adeus",
    inicio: Duration(milliseconds: 29330),
  ...
  Verso(
    ...
    fim: Duration(milliseconds: 60190),
  ),
  Verso(
    ...
    inicio: Duration(milliseconds: 60200),
  ...
  Verso(
    ...
    fim: Duration(milliseconds: 106160),
  ),
  Verso(
    original: "I'll stay here",
    traducao: "Vou ficar aqui",
    inicio: Duration(milliseconds: 106170),
  ...
  Verso(
    ...
    fim: Duration(milliseconds: 252110),
  ),
  Verso(
    original: "♪",
    traducao: "",
    inicio: Duration(milliseconds: 252120),
    fim: Duration(milliseconds: 285990),
  ),
